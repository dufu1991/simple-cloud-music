...
1. 主要技术栈包含 PWA、 Svelte（写小项目真香） 、rollup、svelte-stack-router（可缓存页面的路由管理）、svelte-lazy（懒加载）等。

2. 网易云账号登录（扫码、手机密码或验证码、邮箱密码）。

3. 支持歌词滚动显示。

4. 支持私人 FM 、 每日推荐、心动模式等。

5. 支持查看歌曲热评，评论四楼终于不再是广告了！
...
3. 此应用始终是个纯网页应用，无法在第一级页面返回时提示即将退出应用的二次确认。
